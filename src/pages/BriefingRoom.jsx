...
function StatusBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-8 bg-[#0d1117]/80 border-t border-[#1e2d3d] flex items-center px-3 sm:px-4 z-50">
      <div className="flex items-center gap-2">
        <div className="w-1.5 h-1.5 rounded-full bg-[#00ff88]" />
        <span className="font-mono text-[10px] text-[#4a5568] hidden sm:inline">SECURE CONNECTION ESTABLISHED</span>
      </div>
      <div className="flex-1" />
      <span ref={ref} className="font-mono text-[10px] text-[#1e2d3d] tracking-wider hidden md:inline" />
      <div className="flex-1" />
    ...
    <>
      ...
      >
        ...
        <div ref={ctaRef}>
          <button
            onClick={handleEnter}
            className="group relative font-mono text-sm tracking-widest bg-transparent border border-[#00b4d8]/40 text-[#00b4d8] px-6 sm:px-10 py-3 sm:py-4 rounded hover:bg-[#00b4d8]/10 hover:border-[#00b4d8] hover:shadow-[0_0_20px_rgba(0,180,216,0.2)] active:scale-[0.97] transition-all cursor-pointer"
          >
        ...
        {/* Decorative grid corners — hidden on small screens */}
        <div className="absolute top-8 left-8 w-16 h-16 border-l border-t border-[#1e2d3d] hidden sm:block" />
        <div className="absolute top-8 right-8 w-16 h-16 border-r border-t border-[#1e2d3d] hidden sm:block" />
        <div className="absolute bottom-16 left-8 w-16 h-16 border-l border-b border-[#1e2d3d] hidden sm:block" />
        <div className="absolute bottom-16 right-8 w-16 h-16 border-r border-b border-[#1e2d3d] hidden sm:block" />
      </div>
